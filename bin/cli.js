...
function usage() {
  return [
    'Usage:',
    '  kakao-together-crawler now --format md --out out.md',
    '  kakao-together-crawler goodneighbors --format md --out out.md',
    '  kakao-together-crawler happybean --format md --out out.md',
    '',
    'Commands:',
